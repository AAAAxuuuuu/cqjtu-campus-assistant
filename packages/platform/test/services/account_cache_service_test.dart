...
void main() {
  ...
  group('AccountCacheService tests', () {
    test('triggering cache clear for Account A removes Account A cache and preferences while Account B remains intact', () async {
      ...
      SharedPreferences.setMockInitialValues({
        ...
        'resource_cache_v1:grades:$userAB64:default': '{"summary":{"GPA":"3.8"}}',
        'user_userA_schedule_sunday_first': true,
        'user_userA_dorm_campus': '科学城校区',

        // Account B cache and preference keys
        'resource_cache_v1:schedule:$userBB64:default': '{"courses":["English"]}',
        'resource_cache_v1:grades:$userBB64:default': '{"summary":{"GPA":"3.5"}}',
      ...
      await service.clearAccountCache('userA', accountId: 'userA', prefs: prefs);

      // Verify Account A keys are removed
      expect(prefs.containsKey('resource_cache_v1:schedule:$userAB64:default'), isFalse);
      expect(prefs.containsKey('resource_cache_v1:grades:$userAB64:default'), isFalse);
      ...
      expect(prefs.containsKey('resource_cache_v1:schedule:$userBB64:default'), isTrue);
      expect(prefs.containsKey('resource_cache_v1:grades:$userBB64:default'), isTrue);
      expect(prefs.containsKey('user_userB_schedule_sunday_first'), isTrue);
