    ...
    () {
      test(
        ...
        () async {
          ...
          await service.clearAccountCache(
            'user',
            accountId: 'user',
            prefs: prefs,
          );
          ...
          expect(
            prefs.containsKey('user_user_schedule_sunday_first'),
            isFalse,
            reason: "'user' sunday_first pref must be cleared",
          );
          expect(
            prefs.containsKey('user_user_dorm_campus'),
            isFalse,
      ...
      test(
        ...
        () async {
          ...
          expect(
            prefs.containsKey('resource_cache_v1:schedule:$user1B64:default'),
            isTrue,
          );
          expect(
            prefs.containsKey('user_user_1_schedule_sunday_first'),
