    ...
    test(
      ...
      () async {
        ...
        final seededPrefs = <String, Object>{
          ...
          'resource_cache_v1:schedule:$userAB64Url:default':
              '{"data":"userA_schedule"}',
          'resource_cache_v1:grades:$userAB64Url:default':
              '{"data":"userA_grades"}',
          'resource_cache_v1:exams:$userAB64Std:default':
              '{"data":"userA_exams"}',
          'resource_cache_v1:schedule:default:2026-2027-1':
              '{"data":"unscoped_schedule"}',
          ...
          'resource_cache_v1:schedule:$userBB64Url:default':
              '{"data":"userB_schedule"}',
          'resource_cache_v1:grades:$userBB64Url:default':
              '{"data":"userB_grades"}',
        ...
        expect(
          ...
          isFalse,
          reason: 'Account A schedule cache must be purged',
        );
        expect(
          prefsAfter.containsKey(
            'resource_cache_v1:grades:$userAB64Url:default',
          ...
          isFalse,
          reason: 'Account A grades cache must be purged',
        );
        expect(
          prefsAfter.containsKey(
            'resource_cache_v1:exams:$userAB64Std:default',
          ...
          isFalse,
          reason: 'Account A exams cache must be purged',
        );
        expect(
          prefsAfter.containsKey(
            'resource_cache_v1:schedule:default:2026-2027-1',
          ...
          isFalse,
          reason: 'Unscoped fallback cache must be purged',
        );
        expect(
          prefsAfter.containsKey('user_userA_schedule_sunday_first'),
          isFalse,
          reason: 'Account A scoped pref must be purged',
        );
        expect(
          prefsAfter.containsKey('user_userA_dorm_campus'),
          isFalse,
          reason: 'Account A dorm pref must be purged',
        );
        expect(
          prefsAfter.containsKey(
            'user_userA_schedule_custom_courses_2026-2027-1',
          ...
          isFalse,
          reason: 'Account A custom course pref must be purged',
        );
        expect(
          prefsAfter.containsKey('schedule_custom_courses_2026-2027-1'),
          isFalse,
          reason: 'Legacy custom courses pref must be purged',
        );
        expect(
          prefsAfter.containsKey('schedule_total_weeks_2026-2027-1'),
          isFalse,
          reason: 'Legacy total weeks pref must be purged',
        );
        expect(
          prefsAfter.containsKey('dorm_roomid'),
          isFalse,
          reason: 'Legacy dorm pref must be purged',
        );
        expect(
          prefsAfter.containsKey('semester_start_key_2026-2027-1'),
          isFalse,
          reason: 'Legacy semester start pref must be purged',
        );
        expect(
          prefsAfter.containsKey('selected_semester_str'),
          isFalse,
          reason: 'Legacy selected semester pref must be purged',
        );
        expect(
          prefsAfter.containsKey('schedule_sunday_first'),
          isFalse,
          reason: 'Legacy sunday first pref must be purged',
        );
        ...
        expect(
          ...
          isTrue,
          reason: 'Account B schedule cache must remain intact',
        );
        expect(
          prefsAfter.getString(
            'resource_cache_v1:schedule:$userBB64Url:default',
          ),
          '{"data":"userB_schedule"}',
        );
        expect(
          ...
          isTrue,
          reason: 'Account B grades cache must remain intact',
        );
        expect(
          prefsAfter.containsKey('user_userB_schedule_sunday_first'),
          isTrue,
          reason: 'Account B scoped pref must remain intact',
        );
        expect(prefsAfter.getBool('user_userB_schedule_sunday_first'), false);
        expect(
          prefsAfter.containsKey('user_userB_dorm_campus'),
          isTrue,
          reason: 'Account B dorm pref must remain intact',
        );
        ...
        expect(
          ...
          isTrue,
          reason: 'Account B custom courses must remain intact',
        );
        expect(
          prefsAfter.containsKey('battery_guide_shown'),
          isTrue,
          reason: 'Global setting battery_guide_shown must remain intact',
        );
        expect(prefsAfter.getBool('battery_guide_shown'), true);
        expect(
          prefsAfter.containsKey('app_theme_mode'),
          isTrue,
          reason: 'Global setting app_theme_mode must remain intact',
        );
