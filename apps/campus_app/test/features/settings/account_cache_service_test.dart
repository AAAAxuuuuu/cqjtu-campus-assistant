...
void main() {
  ...
  group('AccountCacheService & clearCurrentAccountCache (R3 & R4)', () {
    test(
      ...
      () async {
        ...
        final initialValues = <String, Object>{
          ...
          'resource_cache_v1:schedule:default:2026-2027-1': 'data_default_schedule',
          ...
          'user_userA_schedule_custom_courses_2026-2027-1': '[{"name":"CourseA"}]',
          ...
          'user_userB_schedule_custom_courses_2026-2027-1': '[{"name":"CourseB"}]',
        ...
        final showInactiveBefore = await container.read(scheduleShowInactiveCoursesProvider.future);
        expect(showInactiveBefore, isFalse);

        // Verify initial state
        final prefsBefore = await SharedPreferences.getInstance();
        expect(prefsBefore.containsKey('resource_cache_v1:schedule:$userAB64:default'), isTrue);
        expect(prefsBefore.containsKey('resource_cache_v1:schedule:$userBB64:default'), isTrue);
        expect(prefsBefore.containsKey('resource_cache_v1:schedule:default:2026-2027-1'), isTrue);
        expect(prefsBefore.containsKey('user_userA_schedule_sunday_first'), isTrue);
        expect(prefsBefore.containsKey('user_userB_schedule_sunday_first'), isTrue);
        ...
        expect(prefsAfter.containsKey('resource_cache_v1:schedule:$userAB64:default'), isFalse);
        expect(prefsAfter.containsKey('resource_cache_v1:grades:$userAB64:default'), isFalse);
        expect(prefsAfter.containsKey('resource_cache_v1:schedule:default:2026-2027-1'), isFalse);
        expect(prefsAfter.containsKey('user_userA_schedule_sunday_first'), isFalse);
        expect(prefsAfter.containsKey('user_userA_schedule_show_inactive_courses'), isFalse);
        expect(prefsAfter.containsKey('user_userA_dorm_campus'), isFalse);
        expect(prefsAfter.containsKey('user_userA_schedule_custom_courses_2026-2027-1'), isFalse);

        expect(prefsAfter.containsKey('schedule_custom_courses_2026-2027-1'), isFalse);
        expect(prefsAfter.containsKey('schedule_total_weeks_2026-2027-1'), isFalse);
        expect(prefsAfter.containsKey('dorm_roomid'), isFalse);
        expect(prefsAfter.containsKey('semester_start_key_2026-2027-1'), isFalse);
        ...
        expect(prefsAfter.containsKey('resource_cache_v1:schedule:$userBB64:default'), isTrue);
        expect(prefsAfter.containsKey('resource_cache_v1:grades:$userBB64:default'), isTrue);
        expect(prefsAfter.containsKey('user_userB_schedule_sunday_first'), isTrue);
        expect(prefsAfter.containsKey('user_userB_dorm_campus'), isTrue);
        expect(prefsAfter.containsKey('user_userB_schedule_custom_courses_2026-2027-1'), isTrue);
        ...
        final showInactiveAfter = await container.read(scheduleShowInactiveCoursesProvider.future);
    ...
    test(
      'clearAccountCache ignores empty or whitespace usernames',
      () async {
        final userAB64 = base64Url.encode(utf8.encode('userA'));
        ...
        expect(prefs.containsKey('resource_cache_v1:schedule:$userAB64:default'), isTrue);
